...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1986: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1987: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1988: (x0,x1) => x0.createElement(x1),
      _2002: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _2012: x0 => globalThis.firebase_core.getApp(x0),
      _2118: x0 => x0.apiKey,
      _2120: x0 => x0.authDomain,
      _2122: x0 => x0.databaseURL,
      _2124: x0 => x0.projectId,
      _2126: x0 => x0.storageBucket,
      _2128: x0 => x0.messagingSenderId,
      _2130: x0 => x0.measurementId,
      _2132: x0 => x0.appId,
      _2134: x0 => x0.name,
      _2135: x0 => x0.options,
      _2158: x0 => new Array(x0),
      _2160: x0 => x0.length,
      _2162: (x0,x1) => x0[x1],
      _2163: (x0,x1,x2) => x0[x1] = x2,
      _2164: x0 => new Promise(x0),
      _2166: (x0,x1,x2) => new DataView(x0,x1,x2),
      _2168: x0 => new Int8Array(x0),
      _2169: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _2170: x0 => new Uint8Array(x0),
      _2176: x0 => new Uint16Array(x0),
      _2178: x0 => new Int32Array(x0),
      _2180: x0 => new Uint32Array(x0),
      _2182: x0 => new Float32Array(x0),
      _2184: x0 => new Float64Array(x0),
      _2189: (o,s,v) => o[s] = v,
      _2190: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2190(f,arguments.length,x0) }),
      _2191: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2191(f,arguments.length,x0) }),
      _2192: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._2192(f,arguments.length,x0,x1) }),
      _2215: () => Symbol("jsBoxedDartObjectProperty"),
      ...
      _2219: x0 => new WeakRef(x0),
      _2220: x0 => x0.deref(),
      _2226: Date.now,
      _2228: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _2229: s => {
      ...
      _2231: () => typeof dartUseDateNowForTicks !== "undefined",
      _2232: () => 1000 * performance.now(),
      _2233: () => Date.now(),
      _2234: () => {
      ...
      _2236: () => new WeakMap(),
      _2237: (map, o) => map.get(o),
      _2238: (map, o, v) => map.set(o, v),
      _2239: () => globalThis.WeakRef,
      _2250: s => JSON.stringify(s),
      _2251: s => printToConsole(s),
      _2252: a => a.join(''),
      _2253: (o, a, b) => o.replace(a, b),
      _2255: (s, t) => s.split(t),
      _2256: s => s.toLowerCase(),
      _2257: s => s.toUpperCase(),
      _2258: s => s.trim(),
      _2259: s => s.trimLeft(),
      _2260: s => s.trimRight(),
      _2261: (s, n) => s.repeat(n),
      _2262: (s, p, i) => s.indexOf(p, i),
      _2263: (s, p, i) => s.lastIndexOf(p, i),
      _2264: (s) => s.replace(/\$/g, "$$$$"),
      _2265: Object.is,
      _2266: s => s.toUpperCase(),
      _2267: s => s.toLowerCase(),
      _2268: (a, i) => a.push(i),
      _2272: a => a.pop(),
      _2273: (a, i) => a.splice(i, 1),
      _2275: (a, s) => a.join(s),
      _2276: (a, s, e) => a.slice(s, e),
      _2279: a => a.length,
      _2281: (a, i) => a[i],
      _2282: (a, i, v) => a[i] = v,
      _2284: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _2285: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _2286: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _2287: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _2288: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _2289: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _2290: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      ...
      _2294: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _2295: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _2296: (t, s) => t.set(s),
      _2298: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _2300: o => o.buffer,
      _2301: o => o.byteOffset,
      _2302: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _2303: (b, o) => new DataView(b, o),
      _2304: (b, o, l) => new DataView(b, o, l),
      _2305: Function.prototype.call.bind(DataView.prototype.getUint8),
      _2306: Function.prototype.call.bind(DataView.prototype.setUint8),
      _2307: Function.prototype.call.bind(DataView.prototype.getInt8),
      _2308: Function.prototype.call.bind(DataView.prototype.setInt8),
      _2309: Function.prototype.call.bind(DataView.prototype.getUint16),
      _2310: Function.prototype.call.bind(DataView.prototype.setUint16),
      _2311: Function.prototype.call.bind(DataView.prototype.getInt16),
      _2312: Function.prototype.call.bind(DataView.prototype.setInt16),
      _2313: Function.prototype.call.bind(DataView.prototype.getUint32),
      _2314: Function.prototype.call.bind(DataView.prototype.setUint32),
      _2315: Function.prototype.call.bind(DataView.prototype.getInt32),
      _2316: Function.prototype.call.bind(DataView.prototype.setInt32),
      _2319: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _2320: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _2321: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _2322: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _2323: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _2324: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _2337: (o, t) => o instanceof t,
      _2339: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2339(f,arguments.length,x0) }),
      _2340: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2340(f,arguments.length,x0) }),
      _2341: o => Object.keys(o),
      _2342: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _2343: (handle) => clearTimeout(handle),
      _2344: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _2345: (handle) => clearInterval(handle),
      _2346: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _2347: () => Date.now(),
      _2348: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _2349: (x0,x1,x2) => x0.fetch(x1,x2),
      _2350: (x0,x1) => x0.get(x1),
      _2351: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._2351(f,arguments.length,x0,x1,x2) }),
      _2352: (x0,x1) => x0.forEach(x1),
      _2354: () => new AbortController(),
      _2355: x0 => x0.getReader(),
      _2356: x0 => x0.read(),
      _2357: x0 => x0.cancel(),
      _2359: () => new XMLHttpRequest(),
      _2360: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _2362: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _2363: (x0,x1) => x0.send(x1),
      _2364: x0 => x0.send(),
      _2367: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2367(f,arguments.length,x0) }),
      _2409: () => globalThis.window.flutter_inappwebview,
      _2415: (x0,x1) => x0.nativeCommunication = x1,
      _2435: (s, m) => {
        try {
      ...
      _2436: (x0,x1) => x0.exec(x1),
      _2437: (x0,x1) => x0.test(x1),
      _2438: (x0,x1) => x0.exec(x1),
      _2439: (x0,x1) => x0.exec(x1),
      _2440: x0 => x0.pop(),
      _2442: o => o === undefined,
      _2461: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _2463: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _2464: o => o instanceof RegExp,
      _2465: (l, r) => l === r,
      _2466: o => o,
      _2467: o => o,
      _2468: o => o,
      ...
      _2470: o => o.length,
      _2473: (o, i) => o[i],
      _2474: f => f.dartFunction,
      _2475: l => arrayFromDartList(Int8Array, l),
      _2476: l => arrayFromDartList(Uint8Array, l),
      _2477: l => arrayFromDartList(Uint8ClampedArray, l),
      _2478: l => arrayFromDartList(Int16Array, l),
      _2479: l => arrayFromDartList(Uint16Array, l),
      _2480: l => arrayFromDartList(Int32Array, l),
      _2481: l => arrayFromDartList(Uint32Array, l),
      _2482: l => arrayFromDartList(Float32Array, l),
      _2483: l => arrayFromDartList(Float64Array, l),
      _2484: x0 => new ArrayBuffer(x0),
      _2485: (data, length) => {
      ...
      _2486: l => arrayFromDartList(Array, l),
      _2487: () => ({}),
      _2488: () => [],
      _2489: l => new Array(l),
      _2490: () => globalThis,
      _2491: (constructor, args) => {
      ...
      _2493: (o, p) => o[p],
      _2494: (o, p, v) => o[p] = v,
      _2495: (o, m, a) => o[m].apply(o, a),
      _2497: o => String(o),
      _2498: (p, s, f) => p.then(s, f),
      _2499: o => {
      ...
      _2500: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmI8ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _2501: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmI8ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _2502: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmI16ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _2503: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmI16ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _2504: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmI32ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _2505: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _2508: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmF64ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _2509: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _2513: x0 => x0.index,
      _2514: x0 => x0.groups,
      _2516: (x0,x1) => x0.exec(x1),
      _2518: x0 => x0.flags,
      _2519: x0 => x0.multiline,
      _2520: x0 => x0.ignoreCase,
      _2521: x0 => x0.unicode,
      _2522: x0 => x0.dotAll,
      _2523: (x0,x1) => x0.lastIndex = x1,
      _2525: (o, p) => o[p],
      _2526: (o, p, v) => o[p] = v,
      _2528: x0 => x0.random(),
      _2529: x0 => x0.random(),
      _2533: () => globalThis.Math,
      _2535: Function.prototype.call.bind(Number.prototype.toString),
      _2536: (d, digits) => d.toFixed(digits),
      _2650: x0 => x0.status,
      _2655: x0 => x0.responseText,
      _2734: x0 => x0.style,
      _3211: x0 => x0.src,
      _3212: (x0,x1) => x0.src = x1,
      _3215: x0 => x0.name,
      _3216: (x0,x1) => x0.name = x1,
      _3217: x0 => x0.sandbox,
      _3218: x0 => x0.allow,
      _3219: (x0,x1) => x0.allow = x1,
      _3220: x0 => x0.allowFullscreen,
      _3221: (x0,x1) => x0.allowFullscreen = x1,
      _3226: x0 => x0.referrerPolicy,
      _3227: (x0,x1) => x0.referrerPolicy = x1,
      _4466: () => globalThis.window,
      _4530: x0 => x0.navigator,
      _4921: x0 => x0.userAgent,
      _7168: x0 => x0.signal,
      ...
      _9797: x0 => x0.url,
      _9799: x0 => x0.status,
      _9801: x0 => x0.statusText,
      _9802: x0 => x0.headers,
      _9803: x0 => x0.body,
      _11959: (x0,x1) => x0.border = x1,
      _12237: (x0,x1) => x0.display = x1,
      _12401: (x0,x1) => x0.height = x1,
      _13091: (x0,x1) => x0.width = x1,
      _14227: x0 => x0.name,
      _14228: x0 => x0.message,
      _14229: x0 => x0.code,
